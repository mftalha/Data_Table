...
import 'package:data_table2/data.dart';
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: SingleChildScrollView(
          //[MTS] alttaki sarı yazıyı kaldırmak için.
          child: Column(
              ...
              SizedBox(
                  ...
                  child: Theme(
                    ...
                    child: PaginatedDataTable(
                      ...
                      source: RowSource(
                        //[MTS] verilerin alındığı yer : galiba
                        myData: myData,
                        count: myData.length,
                      ),
                      rowsPerPage:
                          5, // tablonun her bir sayfasında gösterilen veri miktarı
                      columnSpacing: 8,
                      columns: [
                        DataColumn(
                            label: const Text(
                      ...
                      showFirstLastButtons:
                          true, // tablonun altında ilk veya son sayfayı göster seçeneğinin gösterilmesi için.
